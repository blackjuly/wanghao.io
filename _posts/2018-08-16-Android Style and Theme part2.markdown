...
## **总结**
material design在这一番研究后，让我真心觉得其作用不止是提供给设计一种新规范，给开发一套新组件那么简单，更多也是结合了开发app中的实际情况，针对一些内容进行规范，并且为了方便规范的执行，方便我们开发更好的管理应用，google还使用了提供了颜色，当然material design的内容不止这些，笔者只是针对文字和颜色两方面进行了探究；希望更多的特性能被大家发掘出来！